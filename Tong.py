...
while True:
    ...
    if paddle_size[0] + 25 >= ball_position[0] > 25:
        if ball_position[1] >= paddle1_position[1] and ball_position[1] <= paddle1_position[1] + paddle_size[1]:
            ballXM = (ballXM * -1) + (random.randint(1, 10) / 10)
    ...
    if ball_position[0] >= 720 - 25 - paddle_size[0] and ball_position[0] < 720 - 25:
        if ball_position[1] >= paddle2_position[1] and ball_position[1] <= paddle2_position[1] + paddle_size[1]:
            ballXM = (0 - ballXM) - (random.randint(1, 10) / 10)
